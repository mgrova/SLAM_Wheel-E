...
software externo es expuesto en la seccion4.  \\
...
Para obtener información visual del entorno, se empleará un sensor RGB-D, es decir, la cámara \textit{Kinect v1 for Xbox 360}

Por último, una breve explicación teórica del SLAM y se realizará una comparativa de dos técnicas de SLAM, en concreto \textit{RTAB-Map} y \textit{ORB-SLAM 2}. \\
Además de ello se probará un software de optimización de mapas denominado \textit{Octomap}, el cual ayudará a obtener el mapa de ocupación 2D y 3D.
