...
Las imágenes y medidas de profundidad utilizadas para las técnicas SLAM provienen de una \textit{Kinect for Xbox 360 v1} de Microsoft, que cuenta con una cámara RGB y un sensor de
profundidad matricial. \\
